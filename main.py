...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-m', default='RoHe', type=str, help='name of models')
    ...
    # parser.add_argument('--load_from_pretrained', default='True', help='load model from the checkpoint')
    # parser.add_argument('--max_epoch', default=2, type=int, help='max epoch to train')
